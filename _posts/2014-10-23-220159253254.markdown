---
title: "jquery selectbox 모음"
date: 2014-10-23 12:09:00 +0900
categories: [경험 및 정보 공유]
original_url: "https://blog.naver.com/kkforgg/220159253254"
---

출처 : <http://devnudie.tistory.com/17>

[jQuery select box 관련 Api■ jQuery select box 관련 api // select box ID로 접근하여 선택된 값 읽기 $("#셀렉트박스ID option:selected").val(); // select box Na...devnudie.tistory.com](http://devnudie.tistory.com/entry/jQuery-select-box-관련-Api)
...
// 셀렉트 박스 option의 맨앞에 추가 할 경우$("#셀렉트박스ID").prepend("option value='0'>0번</option>");
