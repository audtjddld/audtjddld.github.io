...
date: 2013-06-04 10:50:00 +0900
categories: [경험 및 정보 공유]
tags: [IT·컴퓨터]
original_url: "https://blog.naver.com/kkforgg/60193294392"
---

출처 : <http://mytory.net/archives/323>
...
- 그냥 ${sessionName}으로 접근한다.
- ${session.sessionName}으로 접근한다.
- scope=”session”으로 접근한다.
